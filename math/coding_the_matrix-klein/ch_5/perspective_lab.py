...
CORNER_PIXELS, FNAME = [(358, 36), (329, 597), (592, 157), (580, 483)], "board.png"
#CORNER_PIXELS, FNAME = [(136, 63), (136, 96), (165, 75), (166, 106)], "cit.png"


veclist = make_nine_equations(CORNER_PIXELS)
...
def mat_move2board(Y):
    ...
    <BLANKLINE>
    '''
    return coldict2mat({lbl:col/col['y3'] for lbl, col in mat2coldict(Y).items()})

## 5.12.5
#(X_pts, colors) = image_mat_util.file2mat(FNAME, ('x1', 'x2', 'x3'))
## 5.12.6
#Y_pts = H * X_pts
## 5.12.7
